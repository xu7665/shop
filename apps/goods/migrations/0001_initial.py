# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-10-20 03:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_front_image_url', models.CharField(default='', max_length=300, verbose_name='封面图URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.CharField(choices=[(1, '一级类目'), (2, '二级类目'), (3, '三级类目')], max_length=30, verbose_name='类目级别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.Goods', verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '轮播图',
