...
class OrderInfo(models.Model):
    ...
    nonce_str = models.CharField(max_length=50,null=True,blank=True,verbose_name=u"")
    trade_no = models.CharField(max_length=100,unique=True,null=True,blank=True,verbose_name=u"支付宝订单号")
    pay_status = models.CharField(choices=ORDER_STATUS,max_length=10,verbose_name=u"订单状态")
